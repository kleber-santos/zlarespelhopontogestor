...
sap.ui.define([
		...
		return BaseController.extend("whr.com.br.ZLAREspelhoPontoGestor.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("Rtext", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("whr.com.br.ZLAREspelhoPontoGestor.view.ViewSettingsDialog", this);
